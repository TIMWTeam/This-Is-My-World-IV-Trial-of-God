...
mods.botania.Apothecary.addRecipe(<mysticalagriculture:water_seeds>,[<extraalchemy:essence_water>,<extraalchemy:essence_water>,<extraalchemy:essence_water>,<extraalchemy:essence_water>,<minecraft:water_bucket>,<botania:rune>,<mysticalagriculture:crafting>,<mysticalagriculture:crafting>,<mysticalagriculture:crafting>,<mysticalagriculture:crafting>]);
mods.botania.Apothecary.addRecipe(<mysticalagriculture:fire_seeds>,[<extraalchemy:essence_fire>,<extraalchemy:essence_fire>,<extraalchemy:essence_fire>,<extraalchemy:essence_fire>,<minecraft:lava_bucket>,<botania:rune:1>,<mysticalagriculture:crafting>,<mysticalagriculture:crafting>,<mysticalagriculture:crafting>,<mysticalagriculture:crafting>]);
