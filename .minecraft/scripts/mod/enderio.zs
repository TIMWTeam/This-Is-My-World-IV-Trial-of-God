...
recipes.addShaped(<enderio:item_basic_capacitor>,[[null,<minecraft:gold_nugget>,null],[<minecraft:gold_nugget>,<ore:ingotCopper>,<minecraft:gold_nugget>],[null,<minecraft:gold_nugget>,null]]);
recipes.addShaped(<enderio:item_basic_capacitor:1>,[[<enderio:item_material:20>,<enderio:item_alloy_ingot:1>,<enderio:item_material:20>],[<enderio:item_basic_capacitor>,<thermalfoundation:material:768>,<enderio:item_basic_capacitor>],[<enderio:item_material:20>,<enderio:item_alloy_ingot:1>,<enderio:item_material:20>]]);