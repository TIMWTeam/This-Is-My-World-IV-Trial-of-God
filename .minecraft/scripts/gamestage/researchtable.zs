...
mods.ResearchTable.builder("aether_transmuter_2", researchType) 
			...
			.setRequiredStages("aether_transmuter_2")
			.setTitle("key.researchTable.aether_transmuter_2.title")
			.setDescription("key.researchTable.aether_transmuter_2.description")
			.addCondition(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:aether_transmuter_2"}))
			.addCondition(<ore:blockSeared>*128)
			.addCondition(<minecraft:stone>*128)
...
mods.ResearchTable.builder("demon_will_coagulator_2", researchType) 
			...
			.setRequiredStages("multi_block")
			.setRequiredStages("demon_will_coagulator_2")
			...
			.addCondition(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:demon_will_coagulator_2"}))
			.addCondition(<liquid:lifeessence> * 5000)
...
mods.ResearchTable.builder("starlight_condenser_2", researchType) 
			...
			.setRequiredStages("multi_block")
			.setRequiredStages("Starlight_Condenser")
			.setRequiredStages("starlight_condenser_2")
			.setTitle("key.researchTable.starlight_condenser_2.title")
			.setDescription("key.researchTable.starlight_condenser_2.description")
			.addCondition(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:starlight_condenser_2"}))
...
mods.ResearchTable.builder("starlight_condenser_3", researchType) 
			...
			.setRequiredStages("multi_block")
			.setRequiredStages("Starlight_Condenser")
			.setRequiredStages("starlight_condenser_3")
			.setTitle("key.researchTable.starlight_condenser_3.title")
			.setDescription("key.researchTable.starlight_condenser_3.description")
			.addCondition(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:starlight_condenser_3"}))
			...
			.build();
//苍穹凝聚器-建造
mods.ResearchTable.builder("vault_condenser", researchType) 
			.setIcons(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:vault_condenser"}))
			.setRequiredStages("multi_block")
			.setRequiredStages("vault_condenser")
			.setTitle("key.researchTable.vault_condenser.title")
			.setDescription("key.researchTable.vault_condenser.description")
			.addCondition(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:vault_condenser"}))
			.addCondition(<astralsorcery:blockcelestialcollectorcrystal>)
			.addCondition(<minecraft:lapis_block>*64)
			.addCondition(<minecraft:quartz_block>*64)
			.addCondition(<minecraft:obsidian>*64)
			.addEnergyCondition(1635400)
			.setNoMaxCount()
			.setRewardCommands("/testruin vault_condenser")
			.build();
