...
mods.ResearchTable.builder("B-003-7", researchType) 
			...
			.build();
//“GayyaIII”：
mods.ResearchTable.builder("GayyaIII", researchType) 
			.setIcons(<extrabotany:material:3>)
			.setTitle("key.researchTable.GayyaIII.title")
			.setDescription("key.researchTable.GayyaIII.description")
			.setRequiredStages("GayyaIII")
			.addCondition(<extrabotany:material:3>)
			.addEnergyCondition(204800)
